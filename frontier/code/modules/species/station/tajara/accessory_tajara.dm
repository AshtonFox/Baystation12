/datum/sprite_accessory/hair/taj
	...
	icon = 'frontier/code/modules/species/station/tajara/sprite_body//hair.dmi'
...
/datum/sprite_accessory/facial_hair/taj
	...
	species_allowed = list(SPECIES_TAJARA)
	icon = 'frontier/code/modules/species/station/tajara/sprite_body/facial.dmi'
...
/datum/sprite_accessory/skin/tajaran
	...
	icon_state = "default"
	icon = 'frontier/code/modules/species/station/tajara/sprite_body/body.dmi'
	species_allowed = list(SPECIES_TAJARA)
