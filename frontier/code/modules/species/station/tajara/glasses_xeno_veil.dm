/obj/item/clothing/glasses/tajblind
	...
	icon_state = "tajblind"
	item_state = "tajblind"
	item_icons = list(slot_glasses_str = 'frontier/code/modules/species/station/tajara/sprite_cloth/onmob_eyes.dmi')
	icon = 'frontier/code/modules/species/station/tajara/sprite_cloth/obj_eyes.dmi'
	prescription = 5
