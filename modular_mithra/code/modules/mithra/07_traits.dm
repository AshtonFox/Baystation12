...
/datum/category_item/player_setup_item/vore/traits/load_character(var/savefile/S)
	from_save(S["custom_species"], pref.custom_species)
	from_save(S["custom_base"], pref.custom_base)
	from_save(S["pos_traits"], pref.pos_traits)
	from_save(S["neu_traits"], pref.neu_traits)
	from_save(S["neg_traits"], pref.neg_traits)
	from_save(S["blood_color"], pref.blood_color)

	from_save(S["traits_cheating"], pref.traits_cheating)
	from_save(S["max_traits"], pref.max_traits)
	from_save(S["trait_points"], pref.starting_trait_points)

/datum/category_item/player_setup_item/vore/traits/save_character(var/savefile/S)
	to_save(S["custom_species"], pref.custom_species)
	to_save(S["custom_base"], pref.custom_base)
	to_save(S["pos_traits"], pref.pos_traits)
	to_save(S["neu_traits"], pref.neu_traits)
	to_save(S["neg_traits"], pref.neg_traits)
	to_save(S["blood_color"], pref.blood_color)

	to_save(S["traits_cheating"], pref.traits_cheating)
	to_save(S["max_traits"], pref.max_traits)
	to_save(S["trait_points"], pref.starting_trait_points)
