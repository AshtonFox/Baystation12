...
/datum/category_item/player_setup_item/vore/ears/load_character(var/savefile/S)
	from_save(S["ear_style"], pref.ear_style)
	from_save(S["r_ears"], pref.r_ears)
	from_save(S["g_ears"], pref.g_ears)
	from_save(S["b_ears"], pref.b_ears)
	from_save(S["r_ears2"], pref.r_ears2)
	from_save(S["g_ears2"], pref.g_ears2)
	from_save(S["b_ears2"], pref.b_ears2)
	from_save(S["tail_style"], pref.tail_style)
	from_save(S["r_tail"], pref.r_tail)
	from_save(S["g_tail"], pref.g_tail)
	from_save(S["b_tail"], pref.b_tail)
	from_save(S["r_tail2"], pref.r_tail2)
	from_save(S["g_tail2"], pref.g_tail2)
	from_save(S["b_tail2"], pref.b_tail2)
	from_save(S["wing_style"], pref.wing_style)
	from_save(S["r_wing"], pref.r_wing)
	from_save(S["g_wing"], pref.g_wing)
	from_save(S["b_wing"], pref.b_wing)

/datum/category_item/player_setup_item/vore/ears/save_character(var/savefile/S)
	to_save(S["ear_style"], pref.ear_style)
	to_save(S["r_ears"], pref.r_ears)
	to_save(S["g_ears"], pref.g_ears)
	to_save(S["b_ears"], pref.b_ears)
	to_save(S["r_ears2"], pref.r_ears2)
	to_save(S["g_ears2"], pref.g_ears2)
	to_save(S["b_ears2"], pref.b_ears2)
	to_save(S["tail_style"], pref.tail_style)
	to_save(S["r_tail"], pref.r_tail)
	to_save(S["g_tail"], pref.g_tail)
	to_save(S["b_tail"], pref.b_tail)
	to_save(S["r_tail2"], pref.r_tail2)
	to_save(S["g_tail2"], pref.g_tail2)
	to_save(S["b_tail2"], pref.b_tail2)
	to_save(S["wing_style"], pref.wing_style)
	to_save(S["r_wing"], pref.r_wing)
	to_save(S["g_wing"], pref.g_wing)
	to_save(S["b_wing"], pref.b_wing)
