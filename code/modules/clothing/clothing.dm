...
/obj/item/clothing/proc/refit_for_species(var/target_species)
	...
	switch(target_species)
		if(SPECIES_HUMAN, SPECIES_SKRELL)	//humanoid bodytypes
			species_restricted = list(SPECIES_HUMAN, SPECIES_SKRELL, SPECIES_IPC, SPECIES_HUMAN2) //skrell/humans/machines can wear each other's suits
		else
...
/obj/item/clothing/head/helmet/refit_for_species(var/target_species)
	...
	switch(target_species)
		if(SPECIES_SKRELL)
			species_restricted = list(SPECIES_HUMAN, SPECIES_SKRELL, SPECIES_IPC, SPECIES_HUMAN2) //skrell helmets fit humans too
		if(SPECIES_HUMAN)
			species_restricted = list(SPECIES_HUMAN, SPECIES_IPC, SPECIES_HUMAN2) //human helmets fit IPCs too
		else
			species_restricted = list(target_species)
...
/obj/item/clothing/gloves
	...
	sprite_sheets = list(
		...
		SPECIES_RESOMI = 'frontier/icons/mob/species/resomi/onmob_hands_resomi.dmi',
		)
...
/obj/item/clothing/mask
	...
	sprite_sheets = list(
		...
		SPECIES_RESOMI = 'frontier/icons/mob/species/resomi/onmob_mask_resomi.dmi',
		)
...
/obj/item/clothing/shoes
	...
	sprite_sheets = list(
		...
		SPECIES_RESOMI = 'frontier/icons/mob/species/resomi/onmob_feet_resomi.dmi',
		)
...
/obj/item/clothing/under
	...
	sprite_sheets = list(
		...
		SPECIES_RESOMI = 'frontier/icons/mob/species/resomi/onmob_under_resomi.dmi',
