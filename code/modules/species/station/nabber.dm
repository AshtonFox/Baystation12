/datum/species/nabber
	...
	assisted_langs = list(LANGUAGE_GUTTER, LANGUAGE_UNATHI_SINTA, LANGUAGE_SKRELLIAN, LANGUAGE_HUMAN_EURO, LANGUAGE_EAL, LANGUAGE_HUMAN_RUSSIAN, LANGUAGE_SIIK_MAAS, LANGUAGE_AKHANI, LANGUAGE_VULP)
	min_age = 18
	max_age = 58
