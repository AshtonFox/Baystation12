...
// Setting this much higher than 3078 could allow spammers to DOS the server easily. - from 1024
#define MAX_MESSAGE_LEN       3078
#define MAX_PAPER_MESSAGE_LEN 9432
#define MAX_BOOK_MESSAGE_LEN  27696 //Safe side to keep it below 30k
